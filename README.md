...
[![GitHub](https://img.shields.io/badge/GitHub-kenanalperen-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/kenanalperen)
...
| **Robotics frameworks** | ROS 2, ROS 1 (Docker) |
| **Control & real-time systems** | Simulink, Simulink Real-Time, Beckhoff TwinCAT |
| **Hardware & platforms** | Franka Emika manipulators, Arduino, custom haptic/electrovibration setups |
| **Design & CAD** | SolidWorks, Siemens NX |
| **Other** | Linux, Git |
...
- Machine learning methods for sign language recognition
- Responsive aerial firefighting aircraft (design study)
...
1. A. Kenan, P. Bremner, M. Giuliani (2025). *Robot Teleoperation Design Requirements from End Users in Nuclear Facilities.* IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS), Hangzhou, China, pp. 6749–6756. [doi:10.1109/IROS60139.2025.11246717](https://doi.org/10.1109/IROS60139.2025.11246717)
2. A. Kenan et al. (2026). *Lessons Learned from the RAICAM Doctoral Network Research Sprints and Field Demonstrations.* Robotics and Autonomous Systems. [doi:10.1016/j.robot.2026.105523](https://doi.org/10.1016/j.robot.2026.105523)
3. A. Kenan et al. (2026). *Lessons Learned from the RAICAM Doctoral Network Research Sprints.* Towards Autonomous Robotic Systems (TAROS 2025), LNCS vol. 16045, Springer, Cham. [doi:10.1007/978-3-032-01486-3_40](https://doi.org/10.1007/978-3-032-01486-3_40)
4. C. Tian, S. K. Arachchige, H. Li, J. J. G. Cárdenas, H. Raei, E. Dincer, A. Kenan et al. (2025). *Low-Cost Rapid-Development Air-Ground Robotic Solution for Nuclear Power Plant Inspection.* IEEE International Symposium on Safety, Security and Rescue Robotics (SSRR), pp. 84–89. [doi:10.1109/SSRR68451.2025.11391258](https://doi.org/10.1109/SSRR68451.2025.11391258)
5. A. Kenan et al. *Robot Learning from Human Demonstrations: Handwritten Alphabet Trajectories and Human-Likeness Evaluation.* IEEE International Conference on Development and Learning (ICDL 2026). [arXiv:2608.06221](https://arxiv.org/abs/2608.06221)
6. J. J. G. Cárdenas, A. Kenan et al. *Design and Evaluation of a Touchscreen-Based Teleoperation Interface for Robotic Manipulators.* IEEE International Conference on Robot and Human Interactive Communication (RO-MAN 2026). [arXiv:2608.06219](https://arxiv.org/abs/2608.06219)
7. A. Kenan et al. *Remote Surfaces at Your Fingertips: Electrovibration-Based Tactile Feedback for Robot Teleoperation via Touchscreen Interfaces.* IEEE Conference on Telepresence 2026. [zenodo.org/records/21740617](https://zenodo.org/records/21740617)
8. A. Kenan et al. *Design and Evaluation of a Collaborative Teleoperation Interface for Multi-Operator Multi-Robot Systems in Challenging Environments.* IEEE Conference on Telepresence 2026. [zenodo.org/records/21740502](https://zenodo.org/records/21740502)

**In Preparation**

- A. Kenan et al. *User-Centred Design of a Touchscreen Teleoperation Interface for Remote Swab Sampling Tasks in Nuclear Environments.* Target: Journal of Field Robotics (Wiley).
- A. Kenan et al. *User-Centred Design of a Multi-Operator Teleoperation Interface for Coordinated Multi-Robot Tasks in Nuclear Environments.* Target: Journal of Field Robotics (Wiley).

---

## 📬 Get in Touch

I'm always happy to talk robotics, teleoperation, haptics, or potential collaborations.

📧 [Alperen.Kenan@uwe.ac.uk](mailto:Alperen.Kenan@uwe.ac.uk) · 💼 [LinkedIn](https://linkedin.com/in/alperen-kenan) · 💻 [GitHub](https://github.com/kenanalperen)
